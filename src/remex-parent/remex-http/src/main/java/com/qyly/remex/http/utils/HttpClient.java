//package com.smart.remex.http.core;
//
...
//import com.smart.remex.http.constant.HttpContentType;
//import com.smart.remex.http.constant.HttpRequestType;
//import com.smart.remex.http.utils.HttpParamUtils;
//import com.smart.remex.utils.Assert;
//import com.smart.remex.utils.CollectionUtils;
//import com.smart.remex.utils.ObjectUtils;
...
//		Assert.notBlank(url, "url is blank");
//		Assert.notNull(httpRequest, "httpRequest is blank");
//		
//		try {
//			// 创建默认的httpClient实例
...
//
//		//键值请求参数
//		if (CollectionUtils.isNotEmpty(paramNameValueList)) {
//			httpPost.setEntity(new UrlEncodedFormEntity(paramNameValueList, Consts.UTF_8));
//		}
//
//		return httpPost;
//	}
...
//			//键值请求参数
//			if (CollectionUtils.isNotEmpty(paramNameValueList)) {
//				uriBuilder.setParameters(paramNameValueList);
//			}
//			
...
//		CollectionUtils.add(paramNameValueList, list);
//		return this;
//	}
//	
//	/**
...
//		Assert.notBlank(name, "header name is blank");
...
//					continue;
//				}
//				addHeader(name, headerMap.get(name));
//			}
//		}
//		return this;
//	}
...
//		Assert.notNull(httpResult, "httpResult is null");
//		
